...
public class versionControl {
    ...
    //The functions checks the files and there’s contents to refresh the version number of the file and the file it self if the particular client as the invalid file.
...
//This functions checks the version of the files and update it when required.
...
//	System.out.println("----SAM----");
    ...
    //It invalidate the file refered by the filename parameter and invalidate it if it has a old version of the file.
